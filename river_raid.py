...
class RiverRaid(object):
    ...
    def train(self, num_frames):
        ...
        while observation_num < num_frames:
            if observation_num % 500 == 99:
                print(("Running training on loop %d" %observation_num))
    ...
    def simulate(self, path = "", save = False):
        ...
        self.env = wrappers.Monitor(self.env, './videos/' + str(time()) + '/',force=True)
        self.env.reset()
        self.env.render()
        while not done:
